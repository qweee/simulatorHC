...
ext_modules = [
    CppExtension(
        ...
        # Optionally add any necessary MKL-specific compile/link flags
    )
]
...
setup(
    ...
    description='homotopy continuation solver for Generalized Relative Pose and Scale problem',
